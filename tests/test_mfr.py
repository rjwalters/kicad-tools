...
class TestDRUFiles:
    ...
    def test_all_6layer_dru_files_valid(self):
        ...
        for dru_file in dru_files:
            ...
            # SMD Pad Clearance, PTH Hole to Track and Inner PTH Hole to Copper. Only the JLC
...
class TestDruGenerator:
    ...
    def test_generate_dru_has_all_jlc_rules(self):
        ...
        Native SMD clearance includes different-net pads within a footprint.
        """
        from kicad_tools.manufacturers.dru_generator import generate_dru
        ...
        assert "SMD Pad Clearance" in content
