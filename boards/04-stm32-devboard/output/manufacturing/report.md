...
|----------------|-------|
| kicad-cli:annular_width | 3 |
| kicad-cli:via_diameter | 3 |
| kicad-cli:starved_thermal | 2 |
| connectivity | 1 |
...
- **[CRITICAL]** Fix 8 blocking DRC violations (kicad-cli: annular_width (3), via_diameter (3), starved_thermal (2))
