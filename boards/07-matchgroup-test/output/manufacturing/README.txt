...
This package contains the reviewed fabrication and assembly release. Its
source identity, native checks, electrical screens and manifest are verified;
hardware testing remains pending. Follow every construction requirement below.
...
Firmware instructions: firmware/source/README.md. Native checked board: matchgroup_test_routed.kicad_pcb in kicad_project.zip. Hardware testing remains pending.
