"""
Geometry primitives for placement optimization.

This module provides 2D vector and polygon classes used for physics calculations
and component bounding boxes.
"""
