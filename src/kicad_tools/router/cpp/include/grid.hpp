...
public:
    ...
    void add_fixed_fill(int layer, double clearance, const std::vector<FillRing>& rings, double via_clearance = -1.0);
    bool fixed_fill_clear(double ax, double ay, double bx, double by,
                          int layer, double half, double reach, bool via_query = false) const;
