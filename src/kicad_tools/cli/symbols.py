"""
List and query symbols in KiCad schematics.

Usage:
    kicad-symbols <schematic.kicad_sch> [options]

Examples:
    kicad-symbols amplifier.kicad_sch
    kicad-symbols amplifier.kicad_sch --filter "U*"
    kicad-symbols amplifier.kicad_sch --format json
"""
