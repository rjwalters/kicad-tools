...
def main():
    parser = argparse.ArgumentParser(
        description="Check BOM parts against manufacturer libraries"
    )
    parser.add_argument("bom", type=Path,
                        help="Path to BOM CSV file")
    parser.add_argument("-m", "--manufacturer", default="jlcpcb",
                        choices=get_manufacturer_ids(),
                        help="Target manufacturer (default: jlcpcb)")
    parser.add_argument("--urls", action="store_true",
                        help="Show search URLs for missing parts")
    parser.add_argument("--export", type=Path,
                        help="Export search URLs to CSV")
